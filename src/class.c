...
// Function: invest_sp
// Return: void
// Description: Main logic for investing skill points. Finds correct skill
//				tree for a given class, handles skill progression, and
//				allocates skill points upon the conditions being satisfied
	...
	if(c->name[0] == 'M' && c->sp > 0) // Medic
	{
		...
		switch(pos)
		{
			...
			case(16): // regen
				...
				break;
			case(17): // cpr
				if(c->skills[14] >= 3 && c->skills[12] >= 5)
				{
					if(c->skills[17] < 10)
					{
						c->skills[17] += 1;
